#!/usr/bin/env python3
"""Create a W8A8-INT8 Qwen3-VL checkpoint with llm-compressor.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--model", default="/mnt/2/pretrained_models/Qwen3-VL-8B-Instruct")
    parser.add_argument(
        "--calib-jsonl",
        default="/mnt/2/carla_metric_result/qwen_w8a8_calib/Qwen3-VL-8B_BF16_idx0-9/calibration_merged.jsonl",
    )
    parser.add_argument(
        "--output-dir",
        default="/mnt/2/pretrained_models/Qwen3-VL-8B-Instruct-W8A8-INT8",
    )
...
def main() -> None:
    ...
    print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print("Qwen3-VL W8A8-INT8 quantization")
    ...
    print(f"smoothquant : {not args.skip_smoothquant} ({args.smoothing_strength})")
    print(f"visual int8 : {args.quantize_visual}")
    ...
    if not args.skip_smoothquant:
        recipe.append(
            SmoothQuantModifier(
                ...
                ignore=["re:.*visual.*"] if not args.quantize_visual else None,
            )
        )
    recipe.append(
        GPTQModifier(
    ...
    metadata = {
        ...
        "smoothquant": not args.skip_smoothquant,
        "smoothing_strength": args.smoothing_strength,
