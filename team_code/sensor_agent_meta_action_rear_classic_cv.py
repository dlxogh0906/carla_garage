...
class SensorAgent(autonomous_agent.AutonomousAgent):
  ...
  def setup(self, path_to_conf_file, route_index=None, traffic_manager=None):
    ...
    from meta_action_rear_vla import MetaActionRearVLAPlanner  # pylint: disable=import-outside-toplevel
  ...
  def _log_qwen_step(self, ttc, ttc_danger, speed_before, speed_after, multiplier, meta_result, control):
    ...
    entry = {
        'experiment': 'rear_classiccv_8meta_action_frontrear',
        ...
        'prompt_mode': 'team8_meta_action_digit_frontrear',
        'action_idx': action_idx,
        'action_name': action_name,
