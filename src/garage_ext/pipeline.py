...
from .modules.base import (Control, Observation, Plan, RiskEstimator,
                           RiskReport, SafetyFilter, VLMModule)
...
class ExtPipeline:
    ...
    def __init__(self, cfg: ExtConfig):
        self.cfg = cfg
        self.vlm: Optional[VLMModule] = (build("vlm", cfg.vlm, **cfg.vlm_kwargs)
